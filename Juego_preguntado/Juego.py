...
caja_pregunta = crear_elemento_juego("textura_pregunta.jpg",ANCHO_PREGUNTA,ALTO_PREGUNTA,710,125)
...
corazon_vida_dos = crear_elemento_juego("corazon_vida.jpg",ANCH0_CORAZON,ALTO_CORAZON,475,125)
corazon_vida_tres = crear_elemento_juego("corazon_vida.jpg",ANCH0_CORAZON,ALTO_CORAZON,535,125)

reloj_tiempo = crear_elemento_juego("RELOJ.png",ANCH0_CORAZON,ALTO_CORAZON,1135,125)


boton_bomba = crear_elemento_juego("BOMBA.png",ANCH0_BOTON_BONUS,ALTO_BOTON_BONUS,100,37)
boton_duplicar_vida = crear_elemento_juego("DUPLICAR.png",ANCH0_BOTON_BONUS,ALTO_BOTON_BONUS,100,225)
