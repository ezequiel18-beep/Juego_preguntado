...
boton_suma = crear_elemento_juego("mas.webp",60,60,1000,300)
boton_resta = crear_elemento_juego("menos.webp",60,60,600,300)
boton_volver = crear_elemento_juego("textura_respuesta.jpg",100,40,420,130)
caja_volumen = crear_elemento_juego("mini_caja.png", 250,120,720,255)
#boton_off_musica = crear_elemento_juego("on_mute.png",60,60,500,200)
boton_on_musica = crear_elemento_juego("mute.png",60,60,800,400)
# Botones

boton_volumen_config = crear_elemento_juego("mini_caja.png", 600, 100, 580, 200)
boton_agregar_preguntas = crear_elemento_juego("mini_caja.png", 600, 100, 580, 350)
boton_dificultad = crear_elemento_juego("mini_caja.png", 600, 100, 580, 500) 
boton_volver_config = crear_elemento_juego("textura_respuesta.jpg", 100, 40, 420, 130)

# BOTONES
boton_facil = crear_elemento_juego("mini_caja.png", 300, 80, 700, 200)
boton_medio = crear_elemento_juego("mini_caja.png", 300, 80, 700, 300)
boton_dificil = crear_elemento_juego("mini_caja.png", 300, 80, 700, 400)
boton_volver = crear_elemento_juego("textura_respuesta.jpg", 100, 40, 420, 130)

# Crear botones
boton_proponer = crear_elemento_juego("mini_caja.png", 600, 80, 500, 350)
boton_importar = crear_elemento_juego("mini_caja.png", 600, 80, 500, 500)
...
def mostrar_ajustes(pantalla:pygame.Surface,cola_eventos:list[pygame.event.Event],datos_juego:dict) -> str:
        ...
        if evento.type == pygame.QUIT:
            ...
            if evento.button == 1:
                if boton_suma["rectangulo"].collidepoint(evento.pos):
                    ...
                    CLICK_SONIDO.play()
                    retorno = "menu"
                # if boton_off_musica["rectangulo"].collidepoint(evento.pos):
    ...
    #pantalla.blit(boton_off_musica["superficie"],boton_off_musica["rectangulo"])
...
#         elif evento.type == pygame.MOUSEBUTTONDOWN:
#             if evento.button == 1:
#                 # Lógica de agregar preguntas (por ahora puede ser solo volver)
#                 retorno = "ajustes"
    
#     pantalla.blit(fondo_pantalla, (0, 0))
#     mostrar_texto(pantalla, "SECCIÓN EN CONSTRUCCIÓN", (600, 300), FUENTE_VOLUMEN, COLOR_BLANCO)
#     return retorno
