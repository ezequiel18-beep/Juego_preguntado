...
fondo_pantalla = pygame.transform.scale(pygame.image.load("GAME_OVER.png"), PANTALLA)

pygame.display.set_caption("Ingresar nombre")

boton_carga = crear_elemento_juego("mini_caja.png", ANCHO_BOTON_PREGUNTA, ALTO_BOTON_PREGUNTA, 670, 450)
...
def mostrar_fin_juego(pantalla: pygame.Surface, partidas, cola_eventos: list, datos_juegos: dict, texto: str = "") -> tuple:
    ...
    limpiar_superficie(boton_carga, "mini_caja.png", ANCHO_BOTON_PREGUNTA, ALTO_BOTON_PREGUNTA)
